...
In Lesson 26, we created the core entity files:
...
The goal of Lesson 27 is to create:
...
In Lesson 25, we planned this folder structure:
...
In Lesson 26 and Lesson 27, I used imports like:
...
For Lesson 27, the main focus is the Kotlin database-layer code.

Gradle setup can be handled when we actually compile the project.

---

## 27. Current files after Lesson 27
...
## 28. What you learned in Lesson 27
...
## Lesson 28 preview
In Lesson 28, we will build the Repository layer.
