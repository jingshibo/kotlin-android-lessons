...
In Lesson 27, we built the Room database layer.
...
The goal of Lesson 28 is to create a useful `MeasurementRepository` that connects the rest of the app to the database.

---

## 1. Where the repository fits

After Lesson 27, our architecture looks like this:
...
In the project structure from Lesson 25, create this file:
...
That will be improved in Lesson 29 and Lesson 30.
...
This function is not the focus of Lesson 28 yet.
...
In Lesson 29, we will connect the repository to:
...
But in Lesson 28, we first made the repository work with Room.
...
In Lesson 34, we will connect export logic.
...
But for Lesson 28, we only prepare the repository base.

---

## 24. Current files after Lesson 28

After Lesson 28, the important file is:
...
In Lesson 29, we will add the fake device source into the real project.
