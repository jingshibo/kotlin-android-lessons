...
In Lesson 31, we completed the main backend/data pipeline for the fake research app.
...
The goal of Lesson 32 is to create the main screen files:
...
We will not fully connect the screens to the ViewModel yet. That will come in Lesson 33.
...
But that is not necessary for Lesson 32.
...
## 22. Current UI files after Lesson 32
...
## 26. What you learned in Lesson 32
...
In Lesson 33, we will connect the screens to navigation and ViewModel state.
