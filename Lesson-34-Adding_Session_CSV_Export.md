...
In Lesson 33, we connected the screens, navigation, ViewModel, repository, fake device, processing, fake ML, and Room database.
...
The goal of Lesson 34 is to let the app export one complete session as a CSV file.
...
In Lesson 33, the Result route had this placeholder:
...
After Lesson 34, the export flow is:
...
## 23. Current architecture after Lesson 34
...
## 24. Current files after Lesson 34
...
## 25. What you learned in Lesson 34
...
## 27. Lesson 35 preview

In Lesson 35, we will test the whole fake-data workflow.
