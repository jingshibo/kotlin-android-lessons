# Lesson 6 Notes - Modifier in Jetpack Compose
...
Lesson 6 used `Modifier` many times for layout:
...
## 3. Common modifiers from Lesson 4 and Lesson 6
...
In Lesson 6, this was used between two buttons in a `Row`.
...
Later, Lesson 6 used `Arrangement.spacedBy`:
