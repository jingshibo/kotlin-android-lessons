# Lesson 8 Notes - Export Callbacks, Temporary State, and Recomposition

This note explains a subtle part of Lesson 8:
...
That is the first reason Lesson 8 used a variable outside `onClick`.

## 2. The Old `pendingCsvText` Method

The method in lesson-08 moves the variable outside the button (old method):
...
For the simple Lesson 8 app, a clean export version is:
