...
This alternative is not required for the first version of Lesson 9. It is just a cleaner architecture direction:
...
## 14. What changed compared with Lesson 8?

In Lesson 8, the screen directly owned the state:
...
In Lesson 9, the ViewModel owns the state:
...
## 18. What you should remember from Lesson 9
