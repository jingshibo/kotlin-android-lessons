# Lesson 9 Notes - Compose Observable State

This note explains an important idea that appears from Lesson 4 to Lesson 9:
...
6. Follow the lesson progression from Lesson 4 to Lesson 9.
...
In Lesson 9, the state moves into the `ViewModel`:
...
## 10. The Lesson 7 pattern: Compose state list

In Lesson 7, the app needed a list of measurements.
...
## 12. The Lesson 8 pattern: temporary export state

In Lesson 8, the app added export-related state:
...
## 13. The Lesson 9 pattern: one UI state object

By Lesson 9, there are many separate state variables:
...
So Lesson 9 creates one data class:
...
Lesson 9 introduces a cleaner architecture:
