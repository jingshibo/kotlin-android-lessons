# Lesson 12 Notes - Coroutines, Threads, and Dispatchers

This note explains how to think about the coroutine pattern used in Lesson 12.
...
## 2. The Main Pattern in Lesson 12
...
In Lesson 12, `suspend` appears because we start using coroutine-only functions.
...
That is why Lesson 12 uses `Dispatchers.IO` for file work.
...
Lesson 12 starts with Style A because it makes the dispatcher visible.
