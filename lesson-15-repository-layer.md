# Lesson 15 — Repository Layer: Separating Data Logic

In Lesson 14, we improved the app state model.
...
So in Lesson 15, we introduce a new idea:
...
In Lesson 11, we saved and loaded measurements from internal storage. The uploaded tutorial specifically introduced internal storage as a beginner-friendly auto-save method. fileciteturn1file0L397-L405
...
This follows the idea from Lesson 12:
...
Before Lesson 15, the ViewModel created fake data directly:
...
## 12. Current architecture after Lesson 15
...
## 17. What You Learned in Lesson 15
...
In Lesson 16, we should introduce:
...
Another drawback of the Lesson 15 file-based approach is that saving one new measurement means saving the whole list again.

In Lesson 15, after creating a measurement, we saved the whole list:
