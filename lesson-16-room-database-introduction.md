...
In Lesson 15, we introduced the **Repository layer**.

Before Lesson 15, the ViewModel was doing too much:
...
After Lesson 15, we started moving data-related work into:
...
In Lesson 15, we already mentioned that storing Activity-related context in long-lived classes can be problematic. For database creation, using application context is the safer beginner-friendly option.

---

## 13. Important change from Lesson 15

In Lesson 15, the repository had this style:
...
A simple Lesson 16 repository can look like this:
...
In Lesson 14, `startAcquisition()` had:
...
## 26. Current Architecture After Lesson 16
...
In Lesson 17, we should move from:
