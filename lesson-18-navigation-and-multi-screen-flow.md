...
In Lesson 17, we changed the app from a simple measurement logger into a more realistic research data model:
...
read lesson-18-notes-screen-layout-architecture.md.
```
...
This matches the data model from Lesson 17.
...
Because in Lesson 17, we decided that measurements should belong to a session.
...
But for Lesson 18, the goal is navigation.
...
## 25. Current architecture after Lesson 18
...
After Lesson 18, the app is no longer just one screen.
...
In Lesson 19, we should prepare for real device communication.
...
The goal of Lesson 19 will not be to fully implement Bluetooth yet.
