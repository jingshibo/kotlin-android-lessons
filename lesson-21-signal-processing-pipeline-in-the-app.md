# Lesson 21 — Signal Processing Pipeline in the App

In Lesson 20, we introduced a cleaner data-source structure:
...
Before Lesson 20, the measurement value came directly from:

```kotlin
Random.nextDouble(0.0, 5.0)
```

After Lesson 20, the repository asked a data source:
...
So Lesson 21 introduces a simple processing pipeline.
...
In Lesson 20, the repository had:
...
In Lesson 20, after adding a measurement, the ViewModel updated:
...
After Lesson 21, the acquisition path becomes:
...
## 21. Updated architecture after Lesson 21
...
## 24. What You Learned in Lesson 21
