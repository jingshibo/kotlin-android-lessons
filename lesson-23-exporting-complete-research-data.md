...
In Lesson 22, the app became more like an **edge-AI research app**:
...
Earlier in the original tutorial, Lesson 8 covered exporting simple measurement data as a CSV file and added an **Export CSV** button with a save-file picker. fileciteturn1file0L270-L306 But now our app has more than only measurements.
...
So Lesson 23 is about exporting **complete research data**, not only a flat measurement list.
...
For Lesson 23, we will start with CSV because it is simpler and very useful for research analysis.
...
In Lesson 22, we mentioned that saving the model version is important.
...
## 21. Export Flow After Lesson 23
...
## 22. Current Architecture After Lesson 23
...
## 23. What You Learned in Lesson 23
...
In Lesson 24, we should step back and review the complete research app architecture.
